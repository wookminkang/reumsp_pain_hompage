...
export const CLINIC = {
  ...
  // 365일 진료·입원 가능 (2026-08-06 담당자 확인).
  // 2026-08-20 담당자 확인: 평일 09~20시, 주말(토·일) 09~13시 점심시간 없이 진료.
  // 공휴일·야간 구체 시간대는 미확정 — 전화 확인 안내로 표기.
  hours: [
    { label: "평일", value: "09:00 – 20:00" },
    { label: "토·일요일", value: "09:00 – 13:00 (점심시간 없이 진료)" },
    { label: "공휴일", value: "진료·입원 가능 (전화 확인)" },
  ],
  /** 입원 병동 병상 수 (2026-08-20 담당자 확인: 65 → 64 정정) */
  beds: 64,
  /** 병실 구성 (1인실 보유 — 2026-08-20 재확인) */
  roomTypes: ["1인실", "2인실", "3인실", "4인실"],
  /**
   * 픽업·드랍 차량 (2026-08-20 담당자 확인).
   * 항암·방사선 치료 목적 내원 환자 전용 — 통증 환자 대상 아님. 대표번호로 선착순 예약.
   */
  shuttle: {
    target: "항암치료·방사선치료 목적 내원 환자 전용",
    reservation: "대표전화 선착순 예약",
    reservationHours: "평일 08:00~18:00",
  },
  /** 진료원장 (대표원장 우선) */
  doctors: [
    { name: "도성국", title: "대표원장" },
  ...
  /**
   * 보유 치료기기 (2026-09-06 담당자 확인).
   * 원고에서 기기가 무엇을 하는 장비인지 기전 설명은 가능하나,
   * 효과 보장·급여 적용 여부 단정은 금지 (의료광고법).
   */
  equipment: [
    { name: "CPM", role: "관절을 일정 범위로 천천히 움직여 주는 지속적 수동 운동 장비" },
    { name: "체외충격파", role: "체외에서 충격파를 전달해 국소 조직을 자극하는 장비" },
    {
      name: "Serapi 근골격계 고주파 치료기",
      role: "고주파 에너지로 심부 조직에 온열을 전달하는 장비",
    },
    { name: "냉각치료기", role: "국소를 냉각해 급성기 부종과 열감을 다루는 장비" },
    { name: "페인스크램블러", role: "피부 전극으로 신호를 보내 통증 신호 전달에 개입하는 장비" },
  ],
